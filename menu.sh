...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= CANDRA VPN STORE WA:081573872702${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
...
echo -e " ${BICyan}[${BIWhite}10${BICyan}]${RED} •${NC} ${YELLOW}TRIAL SSH               $NC  ${BICyan}[${BIWhite}21${BICyan}]${RED} • ${NC}${YELLOW}CLEAR LOG $NC"
